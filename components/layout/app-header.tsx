...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center size-8 rounded-lg border border-border bg-background text-muted-foreground hover:bg-muted hover:text-foreground transition-all duration-150"
    >
      {resolvedTheme === "dark" ? (
      ...
      <div className="flex items-center gap-2">
        ...
        <form action={logoutAction}>
          <button
            ...
            className="flex items-center gap-2 rounded-lg px-2.5 py-1.5 border border-border bg-muted/40 hover:bg-muted transition-all duration-150 group"
          >
